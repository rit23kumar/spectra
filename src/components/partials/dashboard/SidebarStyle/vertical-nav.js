    ...
    return (
       <Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <li className="nav-item static-item">
                    <Link className="nav-link static-item disabled" to="#" tabIndex="-1">
                        <span className="default-icon">Inventory</span>
                        <span className="mini-icon">-</span>
                    </Link>
                </li>
                ...
                <CustomToggle eventKey="sidebar-special" onClick={(activeKey) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/product-category' ? 'active' : ''} nav-link`} to="/product-category">
                                
                                <i className="sidenav-mini-icon"> PC </i>
                                <span className="item-name">Category</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/items' ? 'active' : ''} nav-link`} to="/items">
                ...
                <Accordion.Item as="li" className={`${activeMenu === '0' ? 'active' : ''}`} eventKey="sidebar-auth"  bsPrefix={`nav-item ${active === 'auth' ? 'active' : ''} `} onClick={() => setActive('auth')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-auth">
                        <ul className="sub-nav">
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/sales-order' ? 'active' : '' } nav-link`} to="/sales-order">
                                    
                                    <i className="sidenav-mini-icon"> SO </i>
                                    <span className="item-name">Sales Order</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/placed-orders' ? 'active' : '' } nav-link`} to="/placed-orders">
                                    <i className="sidenav-mini-icon"> PO </i>
                                    <span className="item-name">Placed Orders</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/payment-received' ? 'active' : ''} nav-link`} to="/payment-received">
                                    
                                    <i className="sidenav-mini-icon"> PR </i>
                                    <span className="item-name">Payment Received</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" className={`${activeMenu === '0' ? 'active' : ''}`} eventKey="sidebar-user" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/supplier' ? 'active' : ''} nav-link`} to="/supplier">
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/purchase-order' ? 'active' : ''} nav-link`} to="/purchase-order">
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/payment-made' ? 'active' : ''} nav-link`} to="/payment-made">
                                    
                                    <i className="sidenav-mini-icon"> PM </i>
                                    <span className="item-name">Payment Made</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                ...
                <li className="nav-item static-item">
                    <Link className="nav-link static-item disabled" to="#" tabIndex="-1">
                        <span className="default-icon">Cash Flow</span>
                        <span className="mini-icon">-</span>
                    </Link>
                </li>
                <li className="nav-item">
                <Link className={`${location.pathname === '/earning' ? 'active' : ''} nav-link`} to="/earning">
                        <i className="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">Earning</span>
                    </Link>
                </li>
                <Accordion.Item as="li" eventKey="sidebar-widget" bsPrefix={` ${location.pathname === '/ex-category' || location.pathname === '/ex-create' || location.pathname === '/dashboard/widget/widgetcard' ? 'active' : '' || active === 'widget' ? 'active' : ''} nav-item`} onClick={() => setActive('widget')}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-widget">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/ex-category' ? 'active' : ''} nav-link`} to="/ex-category">
                                    <i className="sidenav-mini-icon"> C </i>
                                    <span className="item-name">Category</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/ex-create' ? 'active' : ''} nav-link`} to="/ex-create">
                                    
                                    <i className="sidenav-mini-icon"> AE </i>
                                    <span className="item-name">Add Expense</span>
                                </Link>
                            </li>
